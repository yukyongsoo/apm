...
public interface CommandInterface {
	...
	public void rowTrans(CastHeader header,Collection<RowTransactionData> dataSet,SessionWaraper session)throws Exception;
	...
	public void dis(CastHeader castHeader, Collection<DistributionData> disSet,SessionWaraper session) throws Exception;
	//multi
	public void multiDBHotSpot(CastHeader castHeader, Collection<DBSpotContainer> dataSet, SessionWaraper session) throws Exception;
	...
	public void multiHotSpot(CastHeader castHeader, Collection<ThreadContainer> mThreadSet, SessionWaraper session) throws Exception;

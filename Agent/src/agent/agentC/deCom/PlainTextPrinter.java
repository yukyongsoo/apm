  ...
  implements Printer
{
  ...
  protected PlainTextPrinter(CommonPreferences preferences, PrintStream printStream)
  {
  ...
  public void startOfOptionalPrefix() { if (!this.preferences.isShowPrefixThis()) {
      this.display = false;
    }
  }
  

  public void endOfOptionalPrefix() { this.display = true; }
